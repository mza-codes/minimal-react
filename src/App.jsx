...
function App() {
  ...
  return (
    <main className='app'>
      <section className='min-h-full h-screen bg-gradient-to-bl from-green-400 to-blue-500 items-center
         justify-center content-center flex flex-col text-center'>
        ...
        <img src="vite.svg" alt="loader" className='max-h-[300px] object-cover max-w-[280px] w-auto h-auto py-2 rounded-xl' />
